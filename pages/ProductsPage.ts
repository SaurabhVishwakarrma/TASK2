...
import { Product, products } from "../test-data/products";
...
export class ProductsPage {
  ...
  constructor(page: Page) {
    ...
    this.p1_add = page.locator(
      '[data-test = "add-to-cart-sauce-labs-backpack"]',
    );

    this.p2_add = page.locator(
      '[data-test = "add-to-cart-sauce-labs-bike-light"]',
    );

    this.cartBadge = page.locator('[data-test = "shopping-cart-badge"]');

    this.p1_removeButton = page.locator(
      '[data-test = "remove-sauce-labs-backpack"]',
    );

    this.p2_removeButton = page.locator(
  ...
  async checkCartBadgeIfNoProducts(): Promise<void> {
